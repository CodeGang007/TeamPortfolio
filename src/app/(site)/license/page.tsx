            ...
            <div className="relative min-h-screen bg-white pt-32 pb-20 overflow-hidden">
                ...
                <div className="container mx-auto px-6 max-w-4xl relative z-10">
                    <div className="mb-12">
                        ...
                        <h1 className="text-4xl md:text-5xl font-bold text-slate-900 mb-6">License Information</h1>
                    ...
                    <div className="prose prose-lg max-w-none">
                        <div className="space-y-12">
                            <section className="space-y-4">
                                <h2 className="text-2xl font-bold text-slate-900">1. Commercial Projects</h2>
                            ...
                            <section className="space-y-4">
                                <h2 className="text-2xl font-bold text-slate-900">3. Third-Party Assets</h2>
                                <p className="text-slate-600 leading-relaxed">
