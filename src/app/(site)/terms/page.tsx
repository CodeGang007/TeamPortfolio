                    ...
                    <div className="prose prose-lg max-w-none">
                        <div className="space-y-12">
                            ...
                            <section className="space-y-4">
                                ...
                                <p className="text-slate-600 leading-relaxed">
                                    CodeGang provides services &ldquo;as is&rdquo; without any express or implied warranties. We are not liable for any damages arising from the use or inability to use our services.
                                </p>
                            </section>
