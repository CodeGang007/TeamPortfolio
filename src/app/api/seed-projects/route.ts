...
const PROJECTS = [
  {
    ...
    gallery: [
      ...
      { src: "/projects/verse-ai-tenant-diagram.webp", caption: "Multi-tenant separation — each org gets its own knowledge boundary" },
    ],
  ...
  },
  {
    ...
    gallery: [
      { src: "/projects/emedici-question-bank.webp", caption: "Question Bank — 46% correct, live scoring across specialties" },
      { src: "/projects/emedici-osce.webp", caption: "OSCE Practice — solo or roleplay with friends" },
      { src: "/projects/emedici-mock-exam.webp", caption: "Mock Exam 2023 — 71% score, 97th percentile across Australia SA" },
    ],
    geography: "Australia",
    sector: "Healthcare",
  ...
  },
  {
    ...
    category: "AI / SaaS",
    image: "/projects/resume-ai-arch.webp",
    gallery: [
      { src: "/projects/resume-ai-arch.webp", caption: "Three-layer architecture — Data, Application & Presentation layers with GitHub Actions CI/CD" },
    ],
    geography: "USA",
  ...
  },
  {
    ...
    gallery: [
      { src: "/projects/nestflow-rents.webp", caption: "Rent dashboard — May 2021, €107,040 outstanding across 4 leases" },
