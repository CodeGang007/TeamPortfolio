...
const PROJECTS = [
  {
    ...
    image: "/projects/verse-ai-login.jpeg",
    gallery: [
      { src: "/projects/verse-ai-login.jpeg", caption: "Live login screen — Verse AI tenant portal" },
      { src: "/projects/verse-ai-aws-arch.jpeg", caption: "7-layer AWS architecture, modular by design" },
      { src: "/projects/verse-ai-chat-flow.jpeg", caption: "Chat request flow — from prompt to streamed response" },
      { src: "/projects/verse-ai-tenant-diagram.jpeg", caption: "Multi-tenant separation — each org gets its own knowledge boundary" },
    ],
    ...
    features: [
      {
        ...
        description:
          "Each company gets its own private knowledge boundary, cryptographically separated from every other tenant.",
      },
      {
        title: "Instant answers",
        description:
          "RAG over the company's docs delivers grounded answers in seconds — no folder digging, no copy-paste.",
      },
      {
        title: "Conversational AI",
        description:
          "Natural multi-turn chat backed by a multi-LLM gateway (Anthropic, OpenAI, Bedrock, self-hosted).",
      },
    ],
    architecture: [
  ...
  },
  {
    ...
    image: "/projects/emedici-question-bank.png",
    gallery: [
      { src: "/projects/emedici-question-bank.png", caption: "Question Bank — 46% correct, live scoring across specialties" },
      { src: "/projects/emedici-osce.png", caption: "OSCE Practice — solo or roleplay with friends" },
      { src: "/projects/emedici-mock-exam.png", caption: "Mock Exam 2023 — 71% score, 97th percentile across Australia SA" },
    ],
    geography: "Australia",
    sector: "Healthcare",
    ...
    badges: [
      ...
      { label: "LIVE ON", value: "Google Play Store" },
    ],
    features: [
  ...
  },
  {
    ...
    image: "/projects/armtech-dashboard.jpeg",
    gallery: [
      { src: "/projects/armtech-dashboard.jpeg", caption: "CementBook Dashboard — sales, profit, stock, receivables, payables, capital" },
      { src: "/projects/armtech-purchases.jpeg", caption: "Purchases — 63 rows, filterable by date, brand, supplier with Excel export" },
      { src: "/projects/armtech-truckbook.jpeg", caption: "TruckBook Dashboard — per-truck P&L, active trucks, total trips, monthly freight" },
      { src: "/projects/armtech-financebook.jpeg", caption: "FinanceBook — Revenue & Capital, bank breakdown, receivables, payables" },
    ],
    ...
    deepLearning: [
      {
        ...
        description:
          "Predicts 7- to 30-day cement-bag demand per brand, godown & region — feeds purchase planning so stockouts and overstocks both drop.",
      },
      {
        title: "Anomaly Detection",
        subtitle: "Autoencoder on tx vectors",
        description:
          "Flags unusual entries in payments, expenses & bank movements — catches data-entry errors and suspicious activity in near real time.",
      },
      {
        title: "Trip Profitability",
        subtitle: "Tabular DL regressor",
        description:
          "Scores every potential truck trip on expected net profit using freight, fuel, route & driver features — guides dispatch in TruckBook.",
      },
      {
        title: "Invoice OCR",
        subtitle: "CNN backbone + Transformer",
        description:
          "Reads supplier bills from a phone camera and auto-fills purchase entries — cuts manual import time per bill from minutes to seconds.",
      },
      {
        title: "Dealer Risk Scoring",
        subtitle: "Tabular DL classifier",
        description:
          "Scores each dealer/party on dormancy and default risk, surfacing accounts that need a follow-up before they go cold.",
      },
    ],
    architecture: [
  ...
  },
  {
    ...
    category: "AI / SaaS",
    image: "/projects/resume-ai-arch.jpeg",
    gallery: [
      { src: "/projects/resume-ai-arch.jpeg", caption: "Three-layer architecture — Data, Application & Presentation layers with GitHub Actions CI/CD" },
    ],
    geography: "USA",
  ...
  },
  {
    ...
    image: "/projects/nestflow-rents.png",
    gallery: [
      { src: "/projects/nestflow-rents.png", caption: "Rent dashboard — May 2021, €107,040 outstanding across 4 leases" },
      { src: "/projects/nestflow-properties.png", caption: "Properties list — all properties with tenants, location and rent" },
      { src: "/projects/nestflow-contract.png", caption: "Tenant lease — contract details, billing, rental breakdown" },
      { src: "/projects/nestflow-property-detail.png", caption: "Property detail — type, name, map location via OpenStreetMap" },
    ],
    geography: "Europe",
    sector: "PropTech",
