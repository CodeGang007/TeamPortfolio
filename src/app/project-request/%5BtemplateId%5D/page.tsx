...
export default function ProjectRequestPage({ params }: { params: ParamsProps }) {
    ...
    const subCategories = ["Adobe Photoshop", "CorelDRAW", "Figma", "Canva", "Realistic", "Anime", "Vectors", "Portrait", "Icons", "Minimal", "Logo", "3D", "Vintage", "Cartoon"];
    ...
    return (
        <div className="flex min-h-screen bg-slate-50 font-sans text-slate-900">
            ...
            <div className="sticky top-0 hidden h-screen w-20 flex-col items-center border-r border-slate-200 bg-white py-8 md:flex">
                <div className="mb-8">
                    <div className="h-8 w-8 rounded-full bg-purple-500"></div> {/* Brand Icon placeholder */}
                </div>
                <div className="flex flex-1 flex-col gap-6 w-full items-center">
                    <button className="text-slate-400 hover:text-purple-600"><Home className="h-6 w-6" /></button>
                    <button className="text-slate-400 hover:text-purple-600"><BarChart2 className="h-6 w-6" /></button>
                    <button className="text-slate-400 hover:text-purple-600"><Wifi className="h-6 w-6 rotate-45" /></button>
                    <button className="text-slate-400 hover:text-purple-600"><MessageCircle className="h-6 w-6" /></button>
                ...
                <div className="mt-auto flex flex-col gap-6">
                    <button className="text-slate-400 hover:text-purple-600"><Settings className="h-6 w-6" /></button>
                    <button className="text-slate-400 hover:text-red-500"><LogOut className="h-6 w-6" /></button>
                </div>
            </div>
            ...
            <div className="flex-1">
                ...
                <div className="container mx-auto mt-6 max-w-7xl px-8 pb-20">
                    ...
                    <div className="mb-8">
                        ...
                        <h1 className="text-3xl font-bold text-blue-400">Project creation</h1>
                    </div>
                    ...
                    <div className="grid grid-cols-1 gap-12 lg:grid-cols-12">
                        ...
                        <div className="lg:col-span-7 space-y-8">
                            ...
                            <div className="space-y-4">
                                ...
                                <p className="text-xs text-slate-400 -mt-3">Select the project category</p>
                            ...
                            <div className="space-y-4">
                                <label className="text-sm font-bold text-slate-700">Sub-Categories</label>
                                <p className="text-xs text-slate-400 -mt-3">Select sub-category</p>
                                        ...
                                        {subCategories.map(sub => (
                                            ...
                                            >
                                                <div className={cn(
                                                    ...
                                                    {formData.subCategories.includes(sub) && <Check className="h-3 w-3 text-white" />}
                                                </div>
                                                <span className={cn(
                                                    "text-xs font-medium text-left",
                                                    formData.subCategories.includes(sub) ? "text-slate-800" : "text-slate-500"
                                                )}>
                                                    {sub}
                                                </span>
                                            </button>
                            ...
                            {/* Estimated Delivery */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-slate-700">Estimated delivery time*</label>
                                <div className="relative">
                                    <input
                                        type="text"
                            ...
                            {/* Estimated Value */}
                            <div className="space-y-2">
                                <label className="text-sm font-bold text-slate-700">Estimated value (BRL)*</label>
                                ...
                                <div className="flex items-center max-w-xs rounded-lg border border-slate-200 bg-white px-4 py-2.5 shadow-sm">
                                    <span className="mr-4 text-xs font-bold text-slate-300">R$</span>
                                    <input
                                        type="text"
                                    ...
                                    <div className="ml-2 flex flex-col">
                                        <button className="h-2 w-2 text-purple-400 hover:text-purple-600">▲</button>
                                        <button className="h-2 w-2 text-purple-400 hover:text-purple-600">▼</button>
                                    </div>
                                </div>
                                <p className="text-[10px] text-slate-400 max-w-md mt-1 leading-relaxed">
                                    Note: We suggest a minimum value of R$15.00. You can negotiate it with a provider later.
                                </p>
                            </div>
                        </div>
                        ...
                        <div className="lg:col-span-5 relative">
                            <div className="sticky top-28 space-y-6">
                                ...
                                <div className="rounded-xl border border-blue-100 bg-white p-6 shadow-sm pt-10">
                                    ...
                                    <p className="text-xs text-slate-400 mb-6">Images of references to the project</p>

                                    <div className="grid grid-cols-2 gap-4 mb-4">
                                        {[1, 2].map((i) => (
                                            <div key={i} className="aspect-[16/10] overflow-hidden rounded-lg bg-slate-100 border border-slate-100">
                                                {/* Mock content */}
                                    ...
                                    <p className="text-[10px] text-slate-400 text-center mb-4">Allowed extensions: .png, .jpg, .jpeg, .gif, ...</p>
                                ...
                                <div className="rounded-xl border border-blue-100 bg-white p-6 shadow-sm">
                                    <label className="text-sm font-bold text-slate-800 mb-1 block">Attachments</label>
                                    <p className="text-xs text-slate-400 mb-6">Project Requirements Attachments</p>

                                    <div className="space-y-3 mb-6">
                                        {["Requirements.pdf", "CorporateBusinessRules.pdf", "Frontend.pdf", "MaisExigências.pdf"].map((file) => (
                                            <div key={file} className="flex items-center justify-between rounded-lg bg-blue-50/50 p-3 hover:bg-blue-100/50 transition-colors cursor-pointer group">
                                                <div className="flex items-center gap-3">
                                                    ...
                                                    <div>
                                                        ...
                                                        <p className="text-[10px] text-slate-400">09/04/2022 • 258.4 KB</p>
                                                    </div>
                                                </div>
                                    ...
                                    <p className="text-[10px] text-slate-400 text-center mb-4">Allowed extensions: .pdf Maximum size: 10MB</p>
                                    <div className="flex justify-end">
                                        <button className="rounded-lg border border-purple-200 bg-white px-6 py-1.5 text-xs font-bold text-purple-600 hover:bg-purple-50 transition-colors">
                                            Add file
                                        </button>
                        ...
                        <div className="lg:col-span-12 mt-4 border-t border-slate-100 pt-8">
                            <label className="text-sm font-bold text-slate-800">Boost (paid feature)</label>
                            <p className="text-xs text-slate-400 mb-8">Have a greater reach with your publication.</p>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-8">
                                ...
                                <div className="lg:col-span-7 flex gap-6">
                                    ...
                                    {/* Standard Card */}
                                    <div
                                        onClick={() => setFormData({ ...formData, boost: "standard" })}
                                        className={cn(
                                            "flex-1 cursor-pointer rounded-xl border bg-white p-6 transition-all text-center relative",
                                            formData.boost === "standard" ? "border-slate-300" : "border-slate-100 opacity-60"
                                        )}
                                    >
                                        <p className="text-xs text-slate-500 mb-1">Standard</p>
                                        <p className="text-2xl font-light text-slate-400 mb-6">Free</p>
                                        ...
                                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2">
                                            <div className={cn("h-4 w-4 rounded-full border-2", formData.boost === "standard" ? "border-purple-400 bg-white" : "border-slate-300")}></div>
                                        </div>
                                    </div>

                                    {/* Driven (Boosted) Card */}
                                    <div
                                        onClick={() => setFormData({ ...formData, boost: "driven" })}
                                        className={cn(
                                    ...
                                    >
                                        ...
                                        <p className="text-2xl font-light text-slate-600 mb-6">R$50</p>
                                        ...
                                        <p className="text-[10px] font-bold text-slate-800 mb-8">Greater visibility</p>

                                        <div className="absolute bottom-6 left-1/2 -translate-x-1/2">
                                            {/* Radio filled with dot */}
                                            <div className={cn("h-4 w-4 rounded-full border border-purple-400 bg-white flex items-center justify-center", formData.boost === "driven" ? "" : "border-slate-300")}>
                                                {formData.boost === "driven" && <div className="h-2.5 w-2.5 rounded-full bg-purple-500 shadow-sm"></div>}
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div className="lg:col-span-5 text-[10px] leading-relaxed text-slate-400 space-y-4 pt-2">
                                    <p>
                                        With the "boosted" option, your publication is publicized with greater reach, being announced in the first display results on the platform,
                                    </p>
                                    <p>
                                        Included in the boost:
                                        <br />One-time payment (once for each publication)
                                        <br />Greater visibility
                                        <br />Featured in display
                                    </p>
