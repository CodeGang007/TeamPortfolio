...
export default function ConfirmationModal({
    ...
    const variantStyles = {
        danger: {
            ...
            button: "bg-gradient-to-r from-red-500 to-red-600 hover:from-red-600 hover:to-red-700 text-slate-900 shadow-lg shadow-red-500/25",
            Icon: AlertCircle,
        },
        warning: {
        ...
        info: {
            ...
            button: "bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-slate-900 shadow-lg shadow-blue-500/25",
            Icon: Info,
        },
    };
            ...
            {isOpen && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed inset-0 bg-white/70 backdrop-blur-md z-50"
                        style={{
                        ...
                        <div className="relative bg-gradient-to-b from-[#1f1f23] to-[#18181b] border border-[#2a2a2e] rounded-2xl shadow-2xl shadow-black/60 overflow-hidden">
                            ...
                            <div className="p-6">
                                ...
                                <div className="flex items-start justify-between mb-5">
                                    ...
                                    <button
                                        onClick={onCancel}
                                        className="p-2 rounded-xl text-slate-400 hover:text-slate-900 hover:bg-slate-100 transition-all duration-200 group"
                                    >
                            ...
                            {/* Actions Footer */}
                            <div className="flex items-center justify-end gap-3 px-6 py-4 bg-[#141416] border-t border-slate-200">
                                <button
                                    onClick={onCancel}
                                    disabled={isLoading}
                                    className="px-5 py-2.5 text-sm font-medium text-slate-500 hover:text-slate-900 bg-transparent hover:bg-slate-100 border border-slate-300 hover:border-[#52525b] rounded-xl transition-all duration-200 disabled:opacity-50"
                                >
                                    {cancelText}
                                </button>
                                <button
