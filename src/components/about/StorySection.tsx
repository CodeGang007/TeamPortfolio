                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
                    ...
                    >
                        <div className="flex items-center gap-4 mb-8">
                            ...
                            <span className="text-brand-green uppercase tracking-widest text-sm font-bold">Who We Are</span>
                        </div>
                        ...
                        <div className="space-y-6 text-lg text-zinc-400 leading-relaxed">
                            ...
                            <blockquote className="border-l-4 border-brand-green pl-6 italic text-white/90 my-8">
                    ...
                    >
                        ...
                        <div className="absolute -inset-4 bg-brand-green/20 blur-3xl rounded-full z-0 opacity-20"></div>

                        <div className="relative rounded-2xl overflow-hidden border border-zinc-800 shadow-2xl z-10 aspect-[4/3]">
                            <div className="absolute inset-0 bg-gradient-to-tr from-brand-green/20 to-transparent mix-blend-overlay z-10 pointer-events-none" />
                            <img
                        ...
                        {/* Floating Badge */}
                        <div className="absolute -bottom-10 -left-10 bg-black/90 backdrop-blur-xl border border-zinc-800 p-8 rounded-2xl shadow-2xl z-20 hover:border-brand-green/50 transition-colors">
                            <div className="flex items-center gap-4">
                                <div className="text-5xl font-bold text-brand-green">4</div>
